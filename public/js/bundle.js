...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/polyfill */ \"./node_modules/@babel/polyfill/lib/index.js\");\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _mapbox_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mapbox.js */ \"./public/js/mapbox.js\");\n/* harmony import */ var _signup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./signup.js */ \"./public/js/signup.js\");\n/* harmony import */ var _login__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./login */ \"./public/js/login.js\");\n/* harmony import */ var _stripe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./stripe */ \"./public/js/stripe.js\");\n/* harmony import */ var _updateSettings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./updateSettings */ \"./public/js/updateSettings.js\");\n/* harmony import */ var _alerts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./alerts */ \"./public/js/alerts.js\");\n/* eslint-disable */\n\n\n\n\n\n\n // Dom elements\n\nconst mapBox = document.getElementById('map');\nconst loginForm = document.querySelector('.form--login');\nconst logOutButton = document.querySelector('.nav__el--logout');\nconst userDataForm = document.querySelector('.form-user-data');\nconst userPasswordForm = document.querySelector('.form-user-password');\nconst signupForm = document.querySelector('.form--signup');\nconst bookBtn = document.getElementById('book-tour'); // Delegation\n\nif (mapBox) {\n  const locations = JSON.parse(mapBox.dataset.locations);\n  Object(_mapbox_js__WEBPACK_IMPORTED_MODULE_1__[\"displayMap\"])(locations);\n}\n\nif (signupForm) {\n  signupForm.addEventListener('submit', e => {\n    e.preventDefault();\n    const name = document.getElementById('name').value;\n    const email = document.getElementById('email').value;\n    const password = document.getElementById('password').value;\n    const passwordConfirm = document.getElementById('passwordConfirm').value;\n    Object(_signup_js__WEBPACK_IMPORTED_MODULE_2__[\"signup\"])(name, email, password, passwordConfirm);\n  });\n}\n\nif (loginForm) {\n  loginForm.addEventListener('submit', e => {\n    e.preventDefault();\n    const email = document.getElementById('email').value;\n    const password = document.getElementById('password').value;\n    Object(_login__WEBPACK_IMPORTED_MODULE_3__[\"login\"])(email, password);\n  });\n}\n\nif (logOutButton) logOutButton.addEventListener('click', _login__WEBPACK_IMPORTED_MODULE_3__[\"logout\"]);\nif (userDataForm) userDataForm.addEventListener('submit', e => {\n  e.preventDefault();\n  const form = new FormData();\n  form.append('name', document.getElementById('name').value);\n  form.append('email', document.getElementById('email').value);\n  form.append('photo', document.getElementById('photo').files[0]);\n  Object(_updateSettings__WEBPACK_IMPORTED_MODULE_5__[\"updateSettings\"])(form, 'data');\n});\nif (userPasswordForm) userPasswordForm.addEventListener('submit', async e => {\n  e.preventDefault();\n  document.querySelector('.btn--save--password').textContent = 'Updating...';\n  const passwordCurrent = document.getElementById('password-current').value;\n  const password = document.getElementById('password').value;\n  const passwordConfirm = document.getElementById('password-confirm').value;\n  await Object(_updateSettings__WEBPACK_IMPORTED_MODULE_5__[\"updateSettings\"])({\n    passwordCurrent,\n    password,\n    passwordConfirm\n  }, 'password');\n  document.querySelector('.btn--save--password').textContent = 'Save Password';\n  document.getElementById('password-current').value = '';\n  document.getElementById('password').value = '';\n  document.getElementById('password-confirm').value = '';\n});\nif (bookBtn) bookBtn.addEventListener('click', e => {\n  e.target.textContent = 'Processing...';\n  const {\n    tourId\n  } = e.target.dataset;\n  Object(_stripe__WEBPACK_IMPORTED_MODULE_4__[\"bookTour\"])(tourId);\n});\nconst alertMessage = document.querySelector('body').dataset.alert;\nif (alertMessage) Object(_alerts__WEBPACK_IMPORTED_MODULE_6__[\"showAlert\"])('success', alertMessage, 20);\n\n//# sourceURL=webpack:///./public/js/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"signup\", function() { return signup; });\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/polyfill */ \"./node_modules/@babel/polyfill/lib/index.js\");\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _alerts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alerts */ \"./public/js/alerts.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_2__);\n/* eslint-disable */\n\n\n\nconst signup = async (name, email, password, passwordConfirm) => {\n  try {\n    const res = await axios__WEBPACK_IMPORTED_MODULE_2___default()({\n      method: 'POST',\n      url: '/api/v1/users/signup',\n      data: {\n        name,\n        email,\n        password,\n        passwordConfirm\n      }\n    });\n\n    if (res.data.status === 'success') {\n      Object(_alerts__WEBPACK_IMPORTED_MODULE_1__[\"showAlert\"])('success', 'Account Created successfully!');\n      window.setTimeout(() => {\n        // to send the user to another page\n        location.assign('/');\n      }, 1500);\n    }\n  } catch (err) {\n    Object(_alerts__WEBPACK_IMPORTED_MODULE_1__[\"showAlert\"])('error', err.response.data.message);\n  }\n};\n\n//# sourceURL=webpack:///./public/js/signup.js?");
